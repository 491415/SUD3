...
class ClanSubjektaDTO(PovijestPodatkaDTO):
    """
    ...
    vrsta_clana_subjekta_id: int = Field(..., ge=1, description="ID vrste člana subjekta.")
    oib: Optional[int] = Field(None, ge=0, le=99999999999, description="Osobni identifikacijski broj člana subjekta (za fizičke i pravne osobe).")
    ...
    drzava_id_registra: Optional[int] = Field(None, ge=1, description="ID države matičnog registra (za pravne osobe).")
    ...
    mbs_u_registru: Optional[int] = Field(None, ge=0, le=999999999,
                                          description="Matični broj subjekta (u ulozi člana subjekta) u sudskom registru.")
    rul: Optional[int] = Field(None, ge=0, le=999999,
