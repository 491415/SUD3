...
class PartneriStatusnihPostupakaDTO(PovijestPodatkaDTO):
    """
    ...
    sifra_opcine: Optional[int] = Field(None, ge=1, le=99_999, description="Šifra općine.")
    naziv_opcine: Optional[str] = Field(None, max_length=128, description="Naziv općine.")
    sifra_naselja: Optional[int] = Field(None, ge=1, le=9_999_999_999, description="Šifra naselja.")
    ...
    kucni_broj: Optional[int] = Field(None, ge=1, le=999_999, description="Kućni broj.")
