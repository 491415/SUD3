...
class ClanSubjektaUdioDTO(PovijestPodatkaDTO):
    """
    ...
    udjel_rbr: Optional[int] = Field(None, ge=0, le=9999, description="Redni broj udjela.")
    prbu_podbroj_od: Optional[int] = Field(None, ge=1, le=9999999999, description="Pravni redni podbroj upisa (samo za virtualne upise).")
    prbu_podbroj_do: Optional[int] = Field(None, ge=1, le=9999999999, description="Pravni redni podbroj upisa (samo za virtualne upise).")
    nominalni_iznos: Decimal = Field(..., ge=0, max_digits=20, decimal_places=2, description="Nominalni iznos udjela.")
    broj_udjela: int = Field(..., ge=0, description="Broj udjela člana subjekta.")
    divizor: Optional[int] = Field(None, ge=1, description="Divizor.")
