...
class StatusniPostupakDTO(PovijestPodatkaDTO):
    """
    ...
    vrsta_statusnog_postupka_id: int = Field(..., ge=1, description="ID vrste statusnog postupka.")
    sud_id_rjesenja: Optional[int] = Field(None, ge=1, description="ID suda rješenja na kojem se statusni postupak temelji.")
