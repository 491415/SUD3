...
class OsobeDTO(PovijestPodatkaDTO):
    """
    ...
    oib: Optional[int] = Field(None, ge=0, le=99_999_999_999, description="Osobni identifikacijski broj osobe.")
    ...
    drzava_id_osobne_isprave: Optional[int] = Field(None, ge=1, le=99_999_999_999, description="ID države osobne isprave.")
    drzava_id: Optional[int] = Field(None, ge=1, le=99_999_999_999, description="ID države prebivališta/sjedišta.")
    ...
    drzava_id_ured: Optional[int] = Field(None, ge=1, le=999_999_999_999, description="ID države ureda.")
    ...
    sifra_opcine_ured: Optional[int] = Field(None, ge=1, le=99_999, description="Šifra općine ureda.")
    naziv_opcine_ured: Optional[str] = Field(None, max_length=128, description="Naziv općine ureda.")
    sifra_naselja_ured: Optional[int] = Field(None, ge=1, le=9_999_999_999, description="Šifra naselja ureda.")
    ...
    sifra_ulice_ured: Optional[int] = Field(None, ge=1, le=9_999_999_999, description="Šifra ulice ureda.")
    ulica_ured: Optional[str] = Field(None, max_length=256, description="Ulica ureda.")
    kucni_broj_ured: Optional[int] = Field(None, ge=1, le=999_999, description="Kućni broj ureda.")
