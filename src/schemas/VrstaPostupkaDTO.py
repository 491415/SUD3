...
T = TypeVar("T", bound="VrstaPostupkaDTO")

class VrstaPostupkaDTO(BaseModel):
    """
    ...
    def as_dict(cls, dto_list: List[T]) -> List[Dict[str, Any]]:
        """
        Konverzija liste VrstaPostupkaDTO u listu dictonarya koristeći Pydantic model_dump
        za serijalizaciju svakog objekta.

        Args:
            dto_list (List[T]): Lista VrstaPostupkaDTO objekata za konverziju.
