...
T = TypeVar("T", bound="RazloziNeaktivnostiDTO")


class RazloziNeaktivnostiDTO(BaseModel):
    """
    ...
    def as_dict(cls, dto_list: List[T]) -> List[Dict[str, Any]]:
        """
        Konverzija liste RazloziNeaktivnostiDTO u listu dictonarya koristeći Pydantic model_dump
        za serijalizaciju svakog objekta.

        Args:
            dto_list (List[T]): Lista RazloziNeaktivnostiDTO objekata za konverziju.
