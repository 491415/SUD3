...
class PravniSljedniciDTO(PovijestPodatkaDTO):
    """
    ...
    mbs_sljednika_u_registru: Optional[int] = Field(None, ge=1, le=999_999_999, description="Matični broj subjekta.")
    ...
    oib_sljednika_izvan_registra: Optional[int] = Field(None, ge=0, le=99_999_999_999, description="OIB pravnog sljednika (za subjekta sljednike izvan sudskog registra).")
