...
class FunkcijeOsobaDTO(PovijestPodatkaDTO):
    """
    ...
    podruznica_rbr: Optional[int] = Field(None, ge=1, le=9_999, description="Redni broj podružnice (ukoliko se funkcija odnosi samo na podružnicu).")
