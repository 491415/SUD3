...
class SjedisteDTO(PovijestPodatkaDTO):
    """
    ...
    drzava_id: Optional[int] = Field(None, ge=1, description="ID države (za domaća sjedišta je NULL).")
    ...
    postanski_broj: Optional[int] = Field(None, ge=10000, le=99999, description="Poštanski broj.")
